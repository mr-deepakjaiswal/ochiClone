...
function Footer() {
  return (
    <div className='w-full h-screen flex gap-5'>
      <div className="w-1/2 h-full pl-16 py-20 flex flex-col justify-between">
        <div className="heading">
          <h1 className='text-[6vw] font-bold leading-none -mb-[1vw] tracking-tighter'>EYE-</h1>
          <h1 className='text-[6vw] font-bold leading-none -mb-[1vw] tracking-tighter'>OPENING</h1>
        </div>
      ...
      <div className="w-1/2 pr-16 py-20 flex flex-col justify-between">
        <div className="heading">
          <h1 className='text-[6vw] font-bold tracking-tighter'>PRESENTATIONS</h1>
          <div className="links mt-10">
            <a className='uppercase text-lg block font-semibold leading-10' href="#">FACEBOOK</a>
            <a className='uppercase text-lg block font-semibold leading-10' href="#">Instagram</a>
            <a className='uppercase text-lg block font-semibold leading-10' href="#">Linkedin</a>
          </div>
        </div>
        <h1 className='flex items-center'><MdCopyright /> ochi design 2024. </h1>
      </div>
    </div>
  )
}
